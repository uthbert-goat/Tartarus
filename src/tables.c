...
const struct clan_type clan_table[MAX_CLAN] =
{
    ...
    {   "ancient",      "[ANCIENT] ",    ROOM_VNUM_ALTAR,        FALSE   },
    {   "life",         "[LIFE] ",       ROOM_VNUM_ALTAR,        FALSE   },
    {   "arcana",       "[ARCANA] ",     ROOM_VNUM_ALTAR,        FALSE   },
    {   "crusader",     "[CRUSADER] ",   ROOM_VNUM_ALTAR,        FALSE   },
    {   "enforcer",     "[ENFORCER] ",   ROOM_VNUM_ALTAR,        FALSE   },
    {   "outlaw",       "[OUTLAW] ",     ROOM_VNUM_ALTAR,        FALSE   }
};
