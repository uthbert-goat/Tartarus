...
/* Clan definitions */
#define CLAN_ANCIENT	1
#define CLAN_LIFE	2
#define CLAN_ARCANA	3
#define CLAN_CRUSADER	4
#define CLAN_ENFORCER	5
#define CLAN_OUTLAW	6
...
#define MOB_VNUM_LIFE		   4500
#define MOB_VNUM_CRUSADER 	   5701
#define MOB_VNUM_OUTLAW		   9900
#define MOB_VNUM_ENFORCER_G	   23600
...
#define ACT_CLAN_MOB             (D)             /* Attacks non-clan  PC's*/
...
#define KEY_LIFE		4500
#define KEY_ENFORCER		23601
#define KEY_OUTLAW		9901
...
/* These are the clan rooms where if you put another Clan's item down
that clan will lose it's powers. Tailor these for you clans then make
clan items for the clan (these are made by setting the object with the
clan item setting).
*/
#define ROOM_VNUM_OUTLAW	    9906
#define ROOM_VNUM_ENFORCER	    23609
#define ROOM_VNUM_CRUSADER	    5708
#define ROOM_VNUM_ARCANA	    4406
#define ROOM_VNUM_ANCIENT	    3808
#define ROOM_VNUM_LIFE		    4512
...
void  clan_shudder	args( (int clan) );
bool  clan_down	args( (CHAR_DATA *ch,int clan) );
