...
int main( int argc, char **argv )
{
    ...
    boot_db( );
    sprintf( log_buf, "Tartarus booted, binding on port %d.", port );
    log_string( log_buf );
...
bool process_output( DESCRIPTOR_DATA *d, bool fPrompt )
{
    ...
    if (IS_SET(ch->act,PLR_EVALUATION))
    {
        ...
        if (percent >= 100)
            ...
            sprintf(wound,"has some some small wounds.");
        else if (percent >= 70)
 ...
 */
	...
	sprintf( log_buf, "%s@%s has connected.", (ch->original_name?ch->original_name:ch->name), d->host );
	log_string( log_buf );
...
/* RT code for breaking link */
	...
	default:
        ...
        sprintf(buf,"%-15s ( no extra xp)",class_table[race].name) :
        sprintf(buf,"%-15s (%3d extra xp)",class_table[race].name,
        class_table[race].xpadd));
                write_to_buffer(d, buf, 0);
        if (++col == 2)
                {
                write_to_buffer(d, "\n\r",0);
...
/* Destroy all clan items...make sure players don't relog with items, can
occur if mud crashes, etc. Don't want clan items being brought in while
another one exists.
*/
	{
	OBJ_DATA *obj;
	...
	if (obj->carried_by == ch)
		...
		|| obj->pIndexData->vnum == OBJ_VNUM_LIFE
		|| obj->pIndexData->vnum == OBJ_VNUM_OUTLAW
		|| obj->pIndexData->vnum == OBJ_VNUM_CRUSADER
...
/* Messy hack for login announcements in clans. */
...
{
sprintf(buf1,"[ARCANA] : \x01B[1;37mThe crystal of power hums briefly as %s enters the lands.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[ARCANA] : \x01B[1;37mThe crystal of power hums briefly as you enter the lands.\x01B[0;37m\n\r");
}
else
{
sprintf(buf1,"[ARCANA] : The crystal of power hums briefly as %s enters the lands.\n\r",ch->name);
sprintf(buf2,"[ARCANA] : The crystal of power hums briefly as you enter the lands.\n\r");
}
break;
case (CLAN_CRUSADER):
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[CRUSADER] : \x01B[1;37mWelcome %s. You bring us strength.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[CRUSADER] : \x01B[1;37mWelcome %s. You bring us strength.\x01B[0;37m\n\r",ch->name);
}
else
{
sprintf(buf1,"[CRUSADER] : Welcome %s. You bring us strength.\n\r",ch->name);
sprintf(buf2,"[CRUSADER] : Welcome %s. You bring us strength.\n\r",ch->name);
}
break;
case (CLAN_LIFE):
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[LIFE] : \x01B[1;37mGreetings %s, Protector of Life.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[LIFE] : \x01B[1;37mGreetings %s, Protector of Life.\x01B[0;37m\n\r",ch->name);
}
else
{
sprintf(buf1,"[LIFE] : Greetings %s, Protector of Life.\n\r",ch->name);
sprintf(buf2,"[LIFE] : Greetings %s, Protector of Life.\n\r",ch->name);
}
...
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[ANCIENT] : \x01B[1;37m%s has joined the Hunt.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[ANCIENT] : \x01B[1;37mGreetings %s, the Hunt awaits you.\x01B[0;37m\n\r",ch->name);
}
else
{
sprintf(buf1,"[ANCIENT] : %s has joined the Hunt.\n\r",ch->name);
sprintf(buf2,"[ANCIENT] : Greetings %s, the Hunt awaits you.\n\r",ch->name);
}
...
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[ENFORCER] : \x01B[1;37mThe law grows stronger with the arrival of %s.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[ENFORCER] : \x01B[1;37mThe law grows stronger with your arrival.\x01B[0;37m\n\r");
}
else
{
sprintf(buf1,"[ENFORCER] : The law grows stronger with the arrival of %s.\n\r",ch->name);
sprintf(buf2,"[ENFORCER] : The law grows stronger with your arrival.\n\r");
}
...
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[OUTLAW] : \x01B[1;37mThe encampment of Outlaws increase as %s enters the realm.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[OUTLAW] : \x01B[1;37mThe encampement of Outlaws increases as you enter the lands.\x01B[0;37m\n\r");
}
else
{
sprintf(buf1,"[OUTLAW] : The encampment of Outlaws increase as %s enters the realm.\n\r",ch->name);
sprintf(buf2,"[OUTLAW] : The encampement of Outlaws increases as you enter the lands.\n\r");
}
...
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[ARCANA] : \x01B[1;37mThe crystal of power dims briefly as %s leaves the lands.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[ARCANA] : \x01B[1;37mThe crystal of power dims briefly as you leave the lands.\x01B[0;37m\n\r");
}
else
{
sprintf(buf1,"[ARCANA] : The crystal of power dims briefly as %s leaves the lands.\n\r",ch->name);
sprintf(buf2,"[ARCANA] : The crystal of power dims briefly as you leave the lands.\n\r");
}
...
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[CRUSADER] : \x01B[1;37mFarewell %s. May your strength return to us soon.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[CRUSADER] : \x01B[1;37mFarewell %s. May your strength return to us soon.\x01B[0;37m\n\r",ch->name);
}
else
{
sprintf(buf1,"[CRUSADER] : Farewell %s. May your strength return to us soon.\n\r",ch->name);
sprintf(buf2,"[CRUSADER] : Farewell %s. May your strength return to us soon.\n\r",ch->name);
}
...
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[LIFE] : \x01B[1;37mThe lands darken a little more as %s leaves the realms.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[LIFE] : \x01B[1;37mThe lands darken a little more as you leave the realms.\x01B[0;37m\n\r");
}
else
{
sprintf(buf1,"[LIFE] : The lands darken a little more as %s leaves the realms.\n\r",ch->name);
sprintf(buf2,"[LIFE] : The lands darken a little more as you leave the realms.\n\r");
}
break;
case (CLAN_ANCIENT):
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[ANCIENT] : \x01B[1;37m%s has left from the Hunt.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[ANCIENT] : \x01B[1;37mFarewell %s, the Hunt awaits your return.\x01B[0;37m\n\r",ch->name);
}
else
{
sprintf(buf1,"[ANCIENT] : %s has left from the Hunt.\n\r",ch->name);
sprintf(buf2,"[ANCIENT] : Farewell %s, the Hunt awaits your return.\n\r",ch->name);
}
...
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[ENFORCER] : \x01B[1;37m%s signs off from duty and leaves the chaotic streets.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[ENFORCER] : \x01B[1;37mMay you return to protect the lawful and protect the streets soon %s.\x01B[0;37m\n\r",ch->name);
}
else
{
sprintf(buf1,"[ENFORCER] : %s signs off from duty and leaves the chaotic streets.\n\r",ch->name);
sprintf(buf2,"[ENFORCER] : May you return to protect the lawful and protect the streets soon %s.\n\r",ch->name);
}
break;
case (CLAN_OUTLAW):
if (IS_SET(ch->comm,COMM_ANSI))
{
sprintf(buf1,"[OUTLAW] : \x01B[1;37m%s disbands from the outlaw encampments for a while.\x01B[0;37m\n\r",ch->name);
sprintf(buf2,"[OUTLAW] : \x01B[1;37mYou disband from the outlaw encampments for a while.\x01B[0;37m\n\r");
}
else
{
sprintf(buf1,"[OUTLAW] : %s disbands from the outlaw encampments for a while.\n\r",ch->name);
sprintf(buf2,"[OUTLAW] : You disband from the outlaw encampments for a while.\n\r");
}
